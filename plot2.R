...
## 
## Plot 2 creates a plot of observed Global Active Power readings over the date range from 2/1/2007 to 2/2/2007
...
png(file = "plot2.png", width = 480, height = 480) ## Create Plot 2 and save to a PNG file
plot(PlotRange$RealTime, PlotRange$Global_active_power, ylab = "Global Active Power (kilowatts)", xlab = "", type = "l")
